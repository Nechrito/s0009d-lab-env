...
namespace Display
{
	...
	Window::Window() : width(1024), height(768), title("gscept Lab Environment"), window(nullptr), vg(nullptr) {}
	...
	void Window::SetCursorPosition(const double x, const double y) const
	{
	...
	{
		glfwSetInputMode(this->window, GLFW_CURSOR, value ? GLFW_CURSOR_NORMAL : GLFW_CURSOR_HIDDEN);
	}
} 